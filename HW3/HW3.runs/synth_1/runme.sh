...
HD_PWD='C:/Users/Dexter/Documents/ECE4525/HW3/HW3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Seg_Decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seven_Seg_Decoder.tcl
