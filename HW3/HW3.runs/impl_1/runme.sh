...
HD_PWD='C:/Users/Dexter/Documents/ECE4525/HW3/HW3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Seg_Decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seven_Seg_Decoder.tcl -notrace
