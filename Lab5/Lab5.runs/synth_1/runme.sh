...
HD_PWD='C:/Users/Dexter/Documents/ECE4525/Lab5/Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRAM_Bus_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRAM_Bus_Controller.tcl
