...
HD_PWD='/archive/scripts/ECE4525/HW2/HW2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Bit_Magnitude_Comparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Four_Bit_Magnitude_Comparator.tcl
