...
HD_PWD='/archive/scripts/ECE4525/HW2/HW2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Bit_Magnitude_Comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Four_Bit_Magnitude_Comparator.tcl -notrace
