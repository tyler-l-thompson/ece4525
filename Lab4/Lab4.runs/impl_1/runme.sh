...
HD_PWD='C:/Users/Dexter/Documents/ECE4525/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Eight_Bit_Magnitude_Comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Eight_Bit_Magnitude_Comparator.tcl -notrace
