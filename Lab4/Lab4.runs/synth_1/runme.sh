...
HD_PWD='C:/Users/Dexter/Documents/ECE4525/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Eight_Bit_Magnitude_Comparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Eight_Bit_Magnitude_Comparator.tcl
