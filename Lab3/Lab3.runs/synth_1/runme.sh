...
HD_PWD='C:/Users/Dexter/Documents/ECE4525/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Task_Two_Part_Two.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Task_Two_Part_Two.tcl
