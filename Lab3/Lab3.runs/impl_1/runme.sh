...
HD_PWD='C:/Users/Dexter/Documents/ECE4525/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Task_Two_Part_Two.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Task_Two_Part_Two.tcl -notrace
